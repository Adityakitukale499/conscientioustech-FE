...
export default function EditEmployee({
  ...
  useEffect(() => {
    axios
      .get("https://conscientioustech-be.onrender.com/department/all", {
        headers: {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(
        `https://conscientioustech-be.onrender.com/department/assign`,
      ...
      .then((response) => {
        ...
        // axios
        //   .post(
        //     `https://conscientioustech-be.onrender.com/employee/update/${editDepartment?._id}`,
        //     {
        //       department,
        //     },
        //     {
