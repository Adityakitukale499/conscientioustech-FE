...
export default function EmployeeList() {
  ...
  const deleteEmployee = (id) => {
    ...
    if (flag) {
      axios
        .delete(
          `https://conscientioustech-be.onrender.com/employee/delete/${id}`,
          {
            headers: {
  ...
  const fetchemployee = () => {
    axios
      .get("https://conscientioustech-be.onrender.com/employee/all", {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("jwt")}`,
        },
  ...
  const filterFunction = () => {
    ...
    const apiUrl = `https://conscientioustech-be.onrender.com/employee/sort?type=${filterBy}&sort=${filterType}`;
    axios
      .get(apiUrl, {
        headers,
      })
